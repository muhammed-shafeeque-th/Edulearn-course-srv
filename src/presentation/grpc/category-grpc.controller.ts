  ...
  async getAllCategories(
    ...
    return await this._tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        return {
          categories: {
            categories: categoriesDto.map((c) =>
              CategoryMapper.toGrpcResponse(c),
            ),
  ...
  async createCategory(
    ...
    return await this._tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        return {
          category: CategoryMapper.toGrpcResponse(category),
        } as CategoryResponse;
      },
    );
  }
  ...
  async updateCategory(
    ...
    return await this._tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        const category = await this._updateCategoryUseCase.execute(data);
  ...
  async toggleCategoryStatus(
    ...
    return await this._tracer.startActiveSpan(
      ...
      async (span) => {
        ...
        const category = await this._toggleCategoryStatusUseCase.execute(
          data.id,
        );
