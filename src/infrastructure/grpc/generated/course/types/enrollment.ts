  ...
  fromJSON(object: any): EnrollmentData {
    return {
      ...
      enrolledAt: isSet(object.enrolledAt)
        ...
        : isSet(object.enrolled_at)
        ? globalThis.String(object.enrolled_at)
        : "",
...
function createBaseEnrollmentDetail(): EnrollmentDetail {
  return { enrollmentId: "", userId: "", courseId: "", progressPercent: 0, status: "", enrolledAt: "", modules: [] };
}
...
export const EnrollmentDetail: MessageFns<EnrollmentDetail> = {
  encode(message: EnrollmentDetail, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.modules) {
      EnrollmentModule.encode(v!, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.modules.push(EnrollmentModule.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EnrollmentDetail {
    return {
      ...
      modules: globalThis.Array.isArray(object?.modules)
        ? object.modules.map((e: any) => EnrollmentModule.fromJSON(e))
        : [],
    };
  },
  ...
  toJSON(message: EnrollmentDetail): unknown {
    ...
    if (message.modules?.length) {
      obj.modules = message.modules.map((e) => EnrollmentModule.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EnrollmentDetail>, I>>(object: I): EnrollmentDetail {
    ...
    message.status = object.status ?? "";
    message.enrolledAt = object.enrolledAt ?? "";
    message.modules = object.modules?.map((e) => EnrollmentModule.fromPartial(e)) || [];
    return message;
  },
};

function createBaseEnrollmentModule(): EnrollmentModule {
  return { id: "", title: "", description: undefined, order: 0, isPublished: false, lessons: [], quiz: undefined };
}

export const EnrollmentModule: MessageFns<EnrollmentModule> = {
  encode(message: EnrollmentModule, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.title !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EnrollmentModule {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseEnrollmentModule();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): EnrollmentModule {
    return {
      id: isSet(object.id) ? globalThis.String(object.id) : "",
      title: isSet(object.title) ? globalThis.String(object.title) : "",
  ...
  toJSON(message: EnrollmentModule): unknown {
    const obj: any = {};
    if (message.id !== "") {
      obj.id = message.id;
    }
  ...
  create<I extends Exact<DeepPartial<EnrollmentModule>, I>>(base?: I): EnrollmentModule {
    return EnrollmentModule.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<EnrollmentModule>, I>>(object: I): EnrollmentModule {
    const message = createBaseEnrollmentModule();
    message.id = object.id ?? "";
    message.title = object.title ?? "";
  ...
  fromJSON(object: any): QuizProgress {
    return {
      ...
      timeLimit: isSet(object.timeLimit)
        ...
        : undefined,
      requirePassingScore: isSet(object.requirePassingScore)
        ? globalThis.Boolean(object.requirePassingScore)
        : isSet(object.require_passing_score)
        ? globalThis.Boolean(object.require_passing_score)
        : false,
