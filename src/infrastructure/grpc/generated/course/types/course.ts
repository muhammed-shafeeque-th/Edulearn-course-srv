...
export const CourseData: MessageFns<CourseData> = {
  encode(message: CourseData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    for (const v of message.modules) {
      ModuleData.encode(v!, writer.uint32(154).fork()).join();
    }
  ...
  fromJSON(object: any): CourseData {
    return {
      ...
      modules: globalThis.Array.isArray(object?.modules)
        ? object.modules.map((e: any) => ModuleData.fromJSON(e))
        : [],
...
export const CourseMetadata: MessageFns<CourseMetadata> = {
  encode(message: CourseMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.noOfModules !== 0) {
      writer.uint32(320).int32(message.noOfModules);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 40: {
          ...
          message.noOfModules = reader.int32();
          continue;
        }
        case 41: {
          if (tag !== 328) {
  ...
  fromJSON(object: any): CourseMetadata {
    return {
      ...
      noOfLessons: isSet(object.noOfLessons)
        ...
        : 0,
      noOfModules: isSet(object.noOfModules)
        ? globalThis.Number(object.noOfModules)
        : isSet(object.no_of_modules)
        ? globalThis.Number(object.no_of_modules)
        : 0,
  ...
  toJSON(message: CourseMetadata): unknown {
    ...
    if (message.noOfModules !== 0) {
      obj.noOfModules = Math.round(message.noOfModules);
    }
    if (message.noOfQuizzes !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<CourseMetadata>, I>>(object: I): CourseMetadata {
    ...
    message.noOfModules = object.noOfModules ?? 0;
